package com.ninad.loans.controller;
...
import com.ninad.loans.dto.ErrorResponseDto;
import com.ninad.loans.dto.LoansContactInfoDto;
import com.ninad.loans.dto.LoansDto;
import com.ninad.loans.dto.ResponseDto;
import com.ninad.loans.service.ILoansService;
...
public class LoansController {
	...
	public ResponseEntity<ResponseDto> createLoan(
			@RequestParam @Pattern(regexp = "(^$|[0-9]{10})", message = LoansConstants.VALID_MOBILE_MESSAGE) String mobileNumber) {
	...
	@Operation(summary = "Get Contact info", description = "Get contact info of loans microservice")
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "HTTP Status OK"),
			@ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class))) })
