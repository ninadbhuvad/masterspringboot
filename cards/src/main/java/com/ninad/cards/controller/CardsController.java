package com.ninad.cards.controller;
...
import com.ninad.cards.constants.CardsConstants;
import com.ninad.cards.dto.CardsContactInfoDto;
import com.ninad.cards.dto.CardsDto;
import com.ninad.cards.dto.ErrorResponseDto;
import com.ninad.cards.dto.ResponseDto;
import com.ninad.cards.service.ICardsService;
...
public class CardsController {
	...
	public ResponseEntity<ResponseDto> createCard(
			@Valid @RequestParam @Pattern(regexp = "(^$|[0-9]{10})", message = CardsConstants.VALID_MOBILE_MESSAGE) String mobileNumber) {
	...
	public ResponseEntity<CardsDto> fetchCardDetails(
			@RequestParam @Pattern(regexp = "(^$|[0-9]{10})", message = CardsConstants.VALID_MOBILE_MESSAGE) String mobileNumber) {
	...
	@Operation(summary = "Get Contact info", description = "Get contact info of cards microservice")
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "HTTP Status OK"),
			@ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class))) })
